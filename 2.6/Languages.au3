...
Func _Language()
	...
	Select
		...
		Case StringInStr("040c,080c,0c0c,100c,140c,180c", @MUILang)
			$lang_found = "French"
		Case StringInStr("040a,080a,0c0a,100a,140a,180a,1c0a,200a,240a,280a,2c0a,300a,340a,380a,3c0a,400a,440a,480a,4c0a,500a", @MUILang)
			$lang_found = "Spanish"
		Case StringInStr("0407,0807,0c07,1007,1407", @MUILang)
			$lang_found = "German"
		Case StringInStr("0416,0816", @MUILang)
		...
		Case StringInStr("0404,0804,0c04,1004,1404", @MUILang)
			$lang_found = "Chinese"
		Case StringInStr("0411", @MUILang)
			$lang_found = "Japanese"
		Case StringInStr("0412", @MUILang)
			$lang_found = "Korean"
		Case StringInStr("041d,081d", @MUILang)
			$lang_found = "Swedish"
		Case StringInStr("0419", @MUILang)
			$lang_found = "Russian"
		Case StringInStr("0413,0813", @MUILang)
			$lang_found = "Dutch"
		Case Else
