...
Func InstallSyslinux($drive_letter)
	Local $line="",$error=""
	SendReport("Start-InstallSyslinux on " & $drive_letter)

	$cmd='"' & @ScriptDir & '\tools\syslinux.exe" -maf -d ' & $drive_letter & '\syslinux ' & $drive_letter
